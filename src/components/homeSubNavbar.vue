                ...
                bind: (el, binding, vnode) => {
                    ...
                    el.ontouchstart = (e) => {
                        ...
                        function touchStart(target, parent, touch) {
                            ...
                            _disY = +offset.top || 0
                            target.style =
                                `position:fixed;z-index:6;left:${_disX}px;top:${_disY}px;width:${itemWidth}px;height:${itemHeight}px`
                        }
                        ...
                        el.ontouchend = (e) => {
                            ...
                            parent.className = parent.className ? parent.className + ' transition' :
                                'transition';
